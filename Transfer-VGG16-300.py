...
tbCallBack = TensorBoard(log_dir='./GraphTransferVgg16-3', 
                         write_graph=True, 
                         write_images=True,
                         write_grads=False)

mdCheckPoint = ModelCheckpoint(filepath='transfer-vgg16.weights3.{epoch:02d}--{val_acc:.5f}.hdf5',
                                monitor='val_acc',
                                mode='max',
...
transfer_vgg16.load_weights('transfer-vgg16.weights2.05--0.33099.hdf5')
...
transfer_vgg16.save_weights('transfer_vgg16_test3.h5') 